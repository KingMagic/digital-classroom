...
import { alterTeacher } from "../service"

type AlterTeacherProps = {
  onBack: () => void;
  selectedTeacher: TeacherItem | undefined
}

const AlterTeacher = ({ onBack, selectedTeacher }: AlterTeacherProps) => {
  ...
  const onFinish = (data: TeacherItem) => {
    return alterTeacher({
      ...data,
    }).then(res => {
      console.log(res)
